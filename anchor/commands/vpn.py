...
def vpn_init(
    ...
    console.print(
        ...
        f"[dim](IP: {_uid_to_ip(cfg['vpn_uid'], cfg['subnet'])})[/dim]\n"
...
def vpn_up() -> None:
    ...
    if my_vpn_uid == 0:
        # Manual setup without vpn_uid: use a best-guess placeholder.
        # The onboarding tunnel may fail; the promote response will contain
        # the real assigned_ip which gets written to the config for next run.
        console.print(
        ...
        my_ip_str = _uid_to_ip(2, subnet)  # best-effort placeholder
    else:
